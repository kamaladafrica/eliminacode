...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, it.kamaladafrica.eliminacode.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, it.kamaladafrica.eliminacode.repository.UserRepository.USERS_BY_EMAIL_CACHE);
